...
- [Next.js 공식 문서](https://nextjs.org/docs) - Next.js의 기능과 API를 학습할 수 있습니다.
...
Next.js 앱을 배포하는 가장 쉬운 방법은 Next.js 제작사인 [Vercel 플랫폼](https://vercel.com/new?utm_medium=default-template&filter=next.js&utm_source=create-next-app&utm_campaign=create-next-app-readme)을 사용하는 것입니다.
